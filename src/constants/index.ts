...
export const links = [
  ...
  { title: "Publications", label: "publication", url: "/", subLinks: [
    { label: 'journal publications', title: 'Journal Publications ', url: '/assets/_01_Elsherbeni_Journal_Articles_July_2026.pdf' },
    ...
    {label: 'conference proceedings', title: 'Conference Proceedings', url: 'assets/_04_Elsherbeni_Conference_Proceedings_January_2025.pdf' },
